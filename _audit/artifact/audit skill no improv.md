...
### 1.2 — The Audit Passes

Run exactly four passes, in order. Do not collapse or skip passes.
...
After the four passes, explicitly scan for these systemic blindspots that are commonly
...
But don't skip a pass because "nothing came up" — run all four, document the scan,
